      ...
      <div className="flex flex-col mx-auto items-center mt-24">
        ...
        <section>
          ...
          <div className="form-group">
            ...
            <input className="border-2 border-gray-300 p-2 rounded-md w-full mb-3" type="form-control" value={name} disabled />
          </div>

          <div className="form-group">
            <label htmlFor="name">Customer Email</label>;
            <input className="border-2 border-gray-300 p-2 rounded-md w-full mb-3" type="form-control" value={email} disabled />
          </div>
        </section>
      </div>
