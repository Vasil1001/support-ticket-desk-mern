      ...
      <div className="flex flex-col min-h-screen mx-auto items-center mt-24 ">
        ...
        >
          ...
          <form className="flex flex-col" onSubmit={onSubmit}>
            <label htmlFor="product" className="block text-gray-900 mb-1">
              Product
            </label>
            <select
              name="product"
            ...
            <label className="block text-gray-700 mt-5 mb-1" htmlFor="name">
              Description
            </label>
            <textarea
              className="border-2 border-gray-600 p-2 rounded-md w-full"
            ...
            <button className="w-lg text-white px-3 p-2 bg-green-700 rounded-md mt-2">
              Create
            </button>
          </form>
        </Card>
