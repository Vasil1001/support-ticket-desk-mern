  ...
  return (
    <section>
      <div className="flex flex-col mx-auto items-center mt-24">
        ...
        <p className="text-gray-600 text-lg">Please fill out the form below to create a new ticket</p>
        ...
        <section>
          ...
          <div className="form-group">
            ...
            <input type="form-control" value={email} disabled />
          </div>
        </section>
      </div>
      <div className="flex flex-col min-h-screen mx-auto items-center mt-24">
        ...
        >
          ...
          <form onSubmit={onSubmit}>
            <label htmlFor="product" className="block font-bold text-gray-600 mt-3 mb-1">
              Product
            </label>
            <select name="product" id="product" value={product} on></select>
            <input
              type="text"
