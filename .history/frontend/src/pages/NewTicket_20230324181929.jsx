      ...
      <div className="flex flex-col mx-auto items-center mt-24">
        <section>
          ...
          <div className="form-group">
            ...
            <input
              className="border-2 border-gray-400 p-2 rounded-md w-full mb-3"
              type="form-control"
              value={name}
              disabled
            />
        ...
        >
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="col-span-1">
              <input
                className="border-2 text-md text-gray-600 border-gray-300 p-1  rounded-md w-full mb-2"
                type="form-control"
                value={name}
                disabled
              />
              <input
                className="border-2 text-sm text-gray-600 border-gray-300 p-1  rounded-md w-full mb-3"
                type="form-control"
                value={email}
                disabled
              />
          ...
          <form className="flex flex-col" onSubmit={onSubmit}>
            ...
            <textarea
              className="border-2 border-slate-600 p-2  rounded-md w-full"
              name="description"
              id="description"
