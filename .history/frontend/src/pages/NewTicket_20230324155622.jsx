  ...
  return (
    <section>
      <div className="flex flex-col mx-auto items-center mt-24">
        <section>
          <h1 className="flex font-bold text-4xl gap-3 justify-center">Create a new ticket</h1>
          ...
          <div className="form-group">
            ...
            <input
              className="border-2 border-gray-300 p-2 bg-slate-50 rounded-md w-full mb-3"
              type="form-control"
              value={name}
              disabled
            />
      ...
      <div className="flex flex-col min-h-screen mx-auto items-center mt-24">
        ...
        >
          ...
          <form className="flex flex-col" onSubmit={onSubmit}>
            ...
            <select
              name="product"
              className="border-2 border-gray-700 p-2  rounded-md w-full"
              id="product"
              value={product}
            ...
            <label className="mt-5" htmlFor="name">Ticket By</label>
            <input
              className="border-2 border-gray-300 p-2  rounded-md w-full mb-3"
              type="form-control"
              value={name}
