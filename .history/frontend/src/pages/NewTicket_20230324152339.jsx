...
function NewTicket() {
  ...
  return (
    <section>
    <div className="flex flex-col min-h-screen mx-auto items-center mt-24"></div>
      ...
      <h1 className="flex font-bold text-4xl gap-3">
        ...
        <p className="text-gray-500 text-lg">Please fill out the following ticket details</p>
