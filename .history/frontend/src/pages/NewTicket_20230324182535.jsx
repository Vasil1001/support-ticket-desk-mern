        ...
        >
          <div className="grid grid-cols-3 gap-5">
            ...
            <div className="col-span-1">
              <input
                className="border-2 text-md text-gray-600 border-gray-300 p-2 px-2  rounded-md w-full mb-2"
                type="form-control"
                value={name}
                disabled
              />
              <input
                className="border-2 text-md text-gray-600 border-gray-300 p-1  rounded-md w-full mb-3"
                type="form-control"
                value={email}
                disabled
              />
