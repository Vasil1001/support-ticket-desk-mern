...
export default function Ticket() {
  ...
  return (
    <div>
      ...
      <h1 className="flex p-2 px-4 my-5 items-center bg-black text-white rounded-md gap-2">Notes</h1> 
      {ticket.status !== "closed" && (
          <button
            className="flex p-2 px-4 my-5 items-center bg-black text-white rounded-md gap-2"
            onClick={openModal}
          >
            <FaPlus /> Add Note
          </button>
