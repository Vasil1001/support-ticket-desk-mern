        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="flex items-center ">
            ...
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 absolute right-3 mb-3 mr-6 cursor-pointer text-gray-500 hover:text-gray-800"
          ...
          <div className="flex items-center ">
            ...
            {passwordShown && (
              ...
              viewBox="0 0 24 24"
                strokeWidth={1.5}
              stroke="currentColor"
              className="w-6 h-6 absolute right-5 mb-3 mr-6 text-gray-500 hover:text-gray-800 cursor-pointer"
