...
export default function TicketItem({ ticket }) {
  return (
    <div className="grid grid-cols-4 text-center mt-3 py-2 bg-gray-200 border shadow-sm border-gray-300 p-2 rounded-xl gap-20 text-lg">
      ...
      <div className="border border-gray-600 rounded-sm px-2 bg-white inline-block align-text-middle text-sm shadow-md"><Link to={`/ticket/${ticket._id}`}>View</Link></div>
