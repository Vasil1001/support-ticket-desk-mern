...
export default function TicketItem({ ticket }) {
  return ( 
    <div className="grid grid-cols-4 text-center wrap overflow-hidden justify-between mt-3 py-2 bg-gray-200 border shadow-sm border-gray-300 p-2 rounded-md text-lg">
